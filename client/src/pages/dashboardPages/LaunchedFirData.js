...
const columns = [
  ...
  {
    field: 'view',align: "center", headerName: 'View',headerAlign: "center", headerClassName: 'super-app-theme--header', width: 200, renderCell: (params) => <ViewDetails personpicture={params.row.personpic}
